                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select id="address" name="address"  class="form-control select2" style="width: 100%;"> <?php fectch_address();?> </select>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group  float-right">
                                            <div class="input-group">
                                                <!-- Save submit -->
                                                <input  type="submit" id="update_submit" name="update_submit" value="Update" class="btn btn-success" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
