                                ...
                                <div class="card-header">
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="pt-2 flex-fill">
                                            <div class="d-flex">
                                                <label for="filter_status" class="pt-2 pr-2 d-flex"> <i
                                                        class="nav-icon fas fa-filter pt-1"></i> Gender</label>
                                                <select id="filter_status" name="filter_status"
                                                    class="form-control select2" style="width: 175px;">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control text-right" id="edit_amount"
                                                disabled>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                ...
                                <input type="hidden" class="form-control" id="delete_payment_id"
                                    name="delete_payment_id">
                            </div>
                        </div>
                        <div class="modal-footer justify-content-between">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
